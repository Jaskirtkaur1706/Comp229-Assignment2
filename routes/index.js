...
var mongoUrl = "mongodb+srv://jaskirat:123@cluster0.uddmv.mongodb.net/";
...
router.get('/', function(req, res) {
    var global_data={
        "page_title":"Jaskirat Kaur - Web Developer"
    };
...
router.get('/services', function(req, res) {
    var global_data={
        "page_title":"Jaskirat Kaur - Services"
    };
...
router.get('/projects', function(req, res) {
    var global_data={
        "page_title":"Jaskirat Kaur - Projects"
    };
...
router.get('/aboutme', function(req, res) {
    var global_data={
        "page_title":"Jaskirat Kaur - About Me"
    };
...
router.get('/contact', function(req, res) {
    var global_data={
        "page_title":"Jaskirat Kaur - Contact"
    };
...
router.get('/update/:id', restricted,function(req, res) {
    var global_data={
        "page_title":"Jaskirat Kaur - Update Contact"
    };
...
router.get('/admin', restricted, function(req, res) {
    ...
    MongoClient.connect(mongoUrl, function(err,db){
        ...
        dbo.collection("contact_list").find().toArray(function(err,results){
            ...
            var global_data={
                "page_title":"Jaskirat Kaur - Manage Contacts",
...
router.get('/login', function(req, res) {
    ...
    var global_data={
        ...
        "page_title":"Jaskirat Kaur - Login"
    };
